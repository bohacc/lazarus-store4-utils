...
begin
 ...
 try
   ...
   begin
     ...
     frmMain.SQLQuery1.ParamByName('ARTICLE').AsString := Win2Utf(XLApp.Cells[x,1].Value);
     // MODEL_NUMBER
     frmMain.SQLQuery1.ParamByName('MODEL_NUMBER').AsString := Win2Utf(XLApp.Cells[x,17].Value);
     // MODEL_NAME
     frmMain.SQLQuery1.ParamByName('MODEL_NAME').AsString := Win2Utf(XLApp.Cells[x,2].Value);
     // COLOUR
     frmMain.SQLQuery1.ParamByName('COLOUR').AsString := Win2Utf(XLApp.Cells[x,4].Value);
     // NET_PRICE
